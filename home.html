				...
				<div class="container-fluid">
					...
					<div class="fh5co-menu-2">
						...
						<? if(!empty($_SESSION['username'])) {
							?><a href="logout.php' data-nav-section='menu'>Logout</a>"<?
						} else {
							?><a href="login.html" data-nav-section="menu">Login</a><?
						}?>
						<?
						  if (!empty($_SESSION['username'])) {
						    ?><a href="profile.html" data-nav-section="menu"><?echo$_SESSION['username'];?></a><?
						  } else {
						    ?><a href="register.html" data-nav-section="menu">Register</a><?
						  ;}
						?>
