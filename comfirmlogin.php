      ...
      <html class="no-js lt-ie9">
         ...
         <html class="no-js">
            ...
            <head>
               ...
               <title>Cellfish &mdash; Confirm Login</title>
...
<?php
  ...
  if (isset($_POST['username'])&&isset($_POST['password'])&&$_POST['username']!="" && $_POST['password']!="") {
	  ...
	  <div style="margin: auto;width: 50%;padding: 10px;"><font color="FFFFFF">
	  <?php
				echo "Incorrect Password! Try Again!<br>Go to the <a href=login.php>Previous</a> Page.";
				?>
			</font></div></div>
			<?php 
			}
	  ...
	  <div style="margin: auto;width: 50%;padding: 10px;"><font color="FFFFFF">
	  <?php
	echo ("You must enter all fields!  <br><br>Return to <a href=\"login.php\">Login</a>.");
  }
?>
</font></div></div>
