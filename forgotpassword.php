...
<head>
  ...
  <title>Cellfish &mdash; Forgot Password</title>
  <!-- Bootstrap core CSS-->
  ...
  <div class="container">
    <div class="card card-register mx-auto mt-5">
      ...
      <div class="card-body">
		...
		<p>Fill in the form and reset the password.</p>
		</div>
        <form action="comfirmforgotpassword.php" method="post">
		<div class="form-group">
            <label for="exampleUsername">Username</label>
            <input class="form-control" id="exampleUsername" name="username" type="username" aria-describedby="" placeholder="Your username">
        </div>
		  <div class="form-group">
        ...
        <div class="text-center">
          ...
          <a class="d-block small" href="register.php">Register</a>
        </div>
      </div>
    </div>
  </div>
